describe('Acessando URL', () => {
    ...
    it('Cadastrar um novo usuário com sucesso selecionando 3 empresas', () => {
        ...
        cy.get('[placeholder="Data de nascimento"]').click().type('1999-11-09');
        ...
        // Dentre as 3 opções de empresas que apareceram, escolha as 3 opções uma por uma, cujo os nomes são "Empresa 1","Empresa 2" e "Empresa 3"
        cy.get('.optionContainer li').eq(0).should('have.text','Empresa 1').click();
        cy.get('.optionContainer li').eq(0).should('have.text','Empresa 2').click();
        cy.get('.optionContainer li').eq(0).should('have.text','Empresa 3').click();
